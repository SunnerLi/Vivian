...
public class PracticeChooseActivity extends Activity implements TextToSpeech.OnInitListener {
    // Fundamental
    TextToSpeech t;
    int textTimes = 0;
    Parser parser;
    ...
    Handler pressHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == Constants.PRESS_BUTTON) {
                ...
                if (is_same) {
                    Toast.makeText(PracticeChooseActivity.this, "Right!", Toast.LENGTH_SHORT).show();
                    YorN = Constants.CORRECT;                                                       // Show correct destop
                } else {
                    Toast.makeText(PracticeChooseActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_choose_activity);
    ...
    public void startSettingActivity() {
        ...
        intent.setClass(PracticeChooseActivity.this, SettingActivity.class);
